return {
  ...
  keys = {
    { '<leader>uu', '<cmd>TestNearest -strategy=toggleterm<CR>', desc = '[U]nit nearest', silent = true, noremap = true },
    -- { '<leader>un', '<cmd>TestNearest -strategy=toggleterm<CR>', desc = '[U]nit [n]earest (toggleterm)', silent = true, noremap = true },
    { '<leader>uf', '<cmd>TestFile -strategy=toggleterm<CR>', desc = '[U]nit [f]ile', silent = true, noremap = true },
